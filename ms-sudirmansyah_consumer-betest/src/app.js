...
kafkaConsumerAdd.consume(`${process.env.KAFKA_TOPIC_PREFIX}user_add`, async (topic, partition, value) => {
...
kafkaConsumerUpdate.consume(`${process.env.KAFKA_TOPIC_PREFIX}user_update`, async (topic, partition, value) => {
	const request = JSON.parse(value);
...
kafkaConsumerDelete.consume(`${process.env.KAFKA_TOPIC_PREFIX}user_delete`, async (topic, partition, value) => {
	const request = JSON.parse(value);
